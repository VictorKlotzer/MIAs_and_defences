...
def check_args(parser):
    ...
    ## set up save_dir
    save_dir = os.path.join(FILE_DIR, '../results', args.model, args.dataset, f'seed{args.random_seed}', 'attacks', 'lira_label_smoothing')
    mkdir(save_dir)
...
class LiRA():
    ...
    def compute_confs(self):
        ...
        for shadow in self.shadow_models:
            ...
            # pred_scores = change_temperature(pred_scores, temperatures.numpy())      #########
