...
*  There are no intermediate model weights saves to reduce the computation time of one epoch; models are just saved once all epochs are done. This is especially useful to avoid extending the training time of LiRA shadow models.
